...
public class ScanService {
    ...
    public void startScan() {
        executor.submit(() -> {
            ...
            while (CashMachineFacade.inProcess) {
                try {
                    String scannedItem = scanner.nextLine().trim();
                    Object process = scanProcessor.process(scannedItem);
                    ...
                    Object total = scanConsumerFactory.consume(checkoutQueue);

                    if (total instanceof String message) {
                        handleCheckoutTotal(message);
                    }
    ...
    private void handleCheckoutTotal(String message) {
